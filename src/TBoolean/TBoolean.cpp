...
signed char TBoolean::getValue() const
{
    return m_value;
}
...
TBoolean TBoolean::comp(TBoolean y)
{
    return ~((*this) - y);
}

TBoolean TBoolean::nand(TBoolean y)
{
    return ~((*this) & y);
}

TBoolean TBoolean::nor(TBoolean y)
{
    return ~((*this) | y);
}
